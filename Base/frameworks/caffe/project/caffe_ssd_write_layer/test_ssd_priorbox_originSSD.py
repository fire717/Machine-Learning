...
net_work_path = './caffe_ssd_deploy2.prototxt'
weight_path = './vgg_ssd_iter_120000.caffemodel'
images_dir = './img/'
result_dir = './out/'
...
def detection_output(mbox_priorbox, mbox_loc, mbox_conf, overlap_threshold=0.3, 
                                confidence_threshold=0.5, top_k=400, keep_top_k=200,):
...
# print("conv4_3_norm: ", out['conv4_3_norm'].shape)#(1, 512, 38, 38))  778752

# out = net.forward(end='fc7')
# print("fc7: ", out['fc7'].shape)#(1, 1024, 19, 19))   369664

# out = net.forward(end='conv6_2')
# print("conv6_2: ", out['conv6_2'].shape)#(1, 512, 10, 10))  51200

# out = net.forward(end='conv7_2')
# print("conv7_2: ", out['conv7_2'].shape)#(1, 256, 5, 5))  6400

# out = net.forward(end='conv8_2')
# print("conv8_2: ", out['conv8_2'].shape)#(1, 256, 3, 3))  2304

# out = net.forward(end='conv9_2')
# print("conv9_2: ", out['conv9_2'].shape)#(1, 256, 1, 1))  256              total = 1208576


##################### prior box
out = net.forward(end='conv4_3_norm_mbox_priorbox')
print("conv4_3_norm_mbox_priorbox: ", out['conv4_3_norm_mbox_priorbox'].shape)#(1, 2, 23104)

out = net.forward(end='fc7_mbox_priorbox')
print("fc7_mbox_priorbox: ", out['fc7_mbox_priorbox'].shape)#(1, 2, 8664)

out = net.forward(end='conv6_2_mbox_priorbox')
print("conv6_2_mbox_priorbox: ", out['conv6_2_mbox_priorbox'].shape)# (1, 2, 2400)

out = net.forward(end='conv7_2_mbox_priorbox')
print("conv7_2_mbox_priorbox: ", out['conv7_2_mbox_priorbox'].shape)#(1, 2, 600)

out = net.forward(end='conv8_2_mbox_priorbox')
print("conv8_2_mbox_priorbox: ", out['conv8_2_mbox_priorbox'].shape)#(1, 2, 144)

out = net.forward(end='conv9_2_mbox_priorbox')
print("conv9_2_mbox_priorbox: ", out['conv9_2_mbox_priorbox '].shape)# (1, 2, 16)


######################## 12 output
    # print("conv4_3_norm_mbox_loc_perm: ", out['conv4_3_norm_mbox_loc_perm'].shape) #(1, 38, 38, 16))  23104
    # print("conv4_3_norm_mbox_conf_perm: ", out['conv4_3_norm_mbox_conf_perm'].shape) # (1, 38, 38, 84) 121296

    # print("fc7_mbox_loc_perm: ", out['fc7_mbox_loc_perm'].shape)#(1, 19, 19, 24)   8664
    # print("fc7_mbox_conf_perm: ", out['fc7_mbox_conf_perm'].shape)#(1, 19, 19, 126)  45486

    # print("conv6_2_mbox_loc_perm: ", out['conv6_2_mbox_loc_perm'].shape)#(1, 10, 10, 24)  2400 
    # print("conv6_2_mbox_conf_perm: ", out['conv6_2_mbox_conf_perm'].shape)#(1, 10, 10, 126) 12600

    # print("conv7_2_mbox_loc_perm: ", out['conv7_2_mbox_loc_perm'].shape)#(1, 5, 5, 24)  600
    # print("conv7_2_mbox_conf_perm: ", out['conv7_2_mbox_conf_perm'].shape)#(1, 5, 5, 126))  3150

    # print("conv8_2_mbox_loc_perm: ", out['conv8_2_mbox_loc_perm'].shape)# (1, 3, 3, 16) 144
    # print("conv8_2_mbox_conf_perm: ", out['conv8_2_mbox_conf_perm'].shape)#(1, 3, 3, 84)  756

    # print("conv9_2_mbox_loc_perm: ", out['conv9_2_mbox_loc_perm'].shape)#(1, 1, 1, 16)    total:34928
    # print("conv9_2_mbox_conf_perm: ", out['conv9_2_mbox_conf_perm'].shape)#(1, 1, 1, 84) total:183372



######################## 3output
print("mbox_priorbox: ", out['mbox_priorbox'].shape) #(1, 2, 34928))
print("mbox_loc: ", out['mbox_loc'].shape) #(1, 34928))
print("mbox_conf_flatten: ", out['mbox_conf_flatten'].shape) #(1, (1, 183372)))

############################### detection_out
    # print("detection_out: ", out['detection_out'].shape) #(1, 1, 87, 7))
    ...
    # print("conv3_3_norm: ", out['conv3_3_norm'].shape)#(1, 32, 30, 40))
    # pWinSizes = [10,16,24]
    # conv3priorbox = prior_box_layer( out['conv3_3_norm'], new_img,  pWinSizes)
    # print("conv3priorbox: ", conv3priorbox.shape)# (38, 38, 12))
    ...
    # out = net.forward(end='conv4_3_norm')
    # print("conv4_3_norm: ", out['conv4_3_norm'].shape)#(1, 64, 15, 20))
    # pWinSizes = [32,48]
    # conv4priorbox = prior_box_layer( out['conv4_3_norm'], new_img,  pWinSizes)
    ...
    # print("conv5_3_norm: ", out['conv5_3_norm'].shape)#(1, 128, 8, 10))
    # pWinSizes = [64,96]
    # conv5priorbox = prior_box_layer( out['conv5_3_norm'], new_img,  pWinSizes)
    ...
    # print("conv6_3_norm: ", out['conv6_3_norm'].shape)#(1,128, 4, 5))
    # pWinSizes = [128,192,256]
    # conv6priorbox = prior_box_layer( out['conv6_3_norm'], new_img,  pWinSizes)
